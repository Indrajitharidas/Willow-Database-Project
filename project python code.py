...
v_query=("select min(diff) as minrent from ("
...
for (minrent) in v_cursor:
  print("\n\n{}".format(minrent))


cnx1 = mysql.connector.connect(user='scott', password='pwd123', host='127.0.0.1', database='project_db2')
v_cursor1 = cnx1.cursor()



v_query1=(" select metro.metro as mtr, diff from (select avg15.metro_metro_id as mtrid, (avg16-avg15) as diff "
" from "
...
v_cursor1.execute(v_query1)


for (mtr, diff) in v_cursor1:
  print("\n\n{} {}".format(mtr, diff))
